...
set_target_properties(brainflow::BoardController PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libBoardController.so"
  IMPORTED_SONAME_DEBUG "libBoardController.so"
  )
...
set_target_properties(brainflow::DataHandler PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libDataHandler.so"
  IMPORTED_SONAME_DEBUG "libDataHandler.so"
  )
...
set_target_properties(brainflow::GanglionLib PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libGanglionLib.so"
  IMPORTED_SONAME_DEBUG "libGanglionLib.so"
  )
...
set_target_properties(brainflow::BrainBitLib PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libBrainBitLib.so"
  IMPORTED_SONAME_DEBUG "libBrainBitLib.so"
  )
...
set_target_properties(brainflow::MLModule PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libMLModule.so"
  IMPORTED_SONAME_DEBUG "libMLModule.so"
  )
